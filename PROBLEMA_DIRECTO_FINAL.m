...
phi1=40%latitud inicio dato S(-) N(+)
lambda0=10%longitud inicio dato W(-) E(+)
alpha1=90%azimuth inicio dato en circular
s12millas=10%distancia dato en metros
%**************************************************************************************
