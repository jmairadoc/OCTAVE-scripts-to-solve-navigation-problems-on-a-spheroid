% Integral I1sigma1
function [I1sigma1] = funcion_I1sigma1(epsilon, sigma1)
          ...
          C11bis=C11*sind(2*1*sigma1);
          C12bis=C12*sind(2*2*sigma1);
          C13bis=C13*sind(2*3*sigma1);
          C14bis=C14*sind(2*4*sigma1);
          C15bis=C15*sind(2*5*sigma1);
          C16bis=C16*sind(2*6*sigma1);
          suma=C11bis+C12bis+C13bis+C14bis+C15bis+C16bis;
          I1sigma1=A1*(sigma1*pi/180+suma);%(15)
